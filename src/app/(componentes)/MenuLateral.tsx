  ...
  return (
    <div className="relative h-screen overflow-hidden bg-gray-100 dark:bg-gray-800">
      <div className="flex items-start justify-between">
        <div className={showMenu ? "relative  h-screen shadow-lg lg:block w-80" : "relative hidden h-screen shadow-lg lg:block w-80"} onMouseLeave={() => { showMenu ? setShowMenu(!showMenu) : setShowMenu(showMenu) }}>
        ...
        <div className="flex flex-col w-full md:space-y-4">
          ...
          <div className="z-40 flex items-center justify-between w-full h-16">
            <div className={!showMenu ? "block ml-6  lg:hidden" : "block ml-6 hidden lg:hidden"}>
              <button className="flex items-center p-2 text-gray-500 bg-white rounded-full shadow text-md" onClick={() => {
            ...
            <div className="relative z-20 flex flex-col justify-end h-full px-3 md:w-full">
              <div className="relative flex items-center justify-end w-full p-1 space-x-4">
                <div className="flex items-center p-2 text-gray-400 bg-white rounded-full shadow hover:text-gray-700 text-md">
                  <svg
                    width={20}
                    height={20}
                    fill="currentColor"
                ...
                <button onClick={() => { signOut({ callbackUrl: 'http://localhost:3000/' }) }} className="flex items-center text-gray-500 dark:text-white text-md">
                  {session?.user?.name}
                  <button >
                    <svg
                      width={20}
          ...
          <div className="h-screen px-4 pb-24 overflow-auto md:px-6 flex flex-col">
            {children}
          </div>
        </div>
      </div>
